            ...
            <div className="shadow-card dark:bg-gray-dark rounded-3xl border border-stroke bg-white px-8 py-11 dark:border-stroke-dark sm:p-[55px] lg:px-8 xl:p-[55px]">
              ...
              <div className="flex space-x-4">
                <button
                  ...
                  className="flex items-center justify-center rounded-lg bg-[#25D366] px-6 py-3 text-white hover:bg-[#1ebe5d] transition-colors"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center rounded-lg bg-primary px-6 py-3 text-white hover:bg-primary-dark transition-colors"
                >
                  <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
