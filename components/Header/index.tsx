    ...
    <>
      <header
        className={`header left-0 top-0 z-40 flex w-full items-center ${
          sticky
            ? "fixed z-[9999] border-b border-stroke/60 bg-white/75 shadow-sticky backdrop-blur-xl transition dark:border-stroke-dark/60 dark:bg-gray-dark/80 dark:shadow-sticky-dark"
