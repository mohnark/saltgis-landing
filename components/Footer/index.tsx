              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <a
                    ...
                    className="dark:text-body-color-dark mr-6 text-body-color/40 duration-300 cursor-not-allowed"
                  ...
                  <a
                    href="#"
                    aria-label="social-link"
                    className="dark:text-body-color-dark text-body-color/40 duration-300 cursor-not-allowed"
                    style={{ pointerEvents: 'none' }}
                  >
                    <svg
                      width="18"
